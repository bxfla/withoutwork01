...
import com.xb.powerplatform.my_tasks.fragment.MyTaskFragment01;
import com.xb.powerplatform.my_tasks.fragment.MyTaskFragment02;
...
public class TaskaHonestActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment0 = new MyTaskFragment01();
        fragment1 = new MyTaskFragment02();
        list.add(fragment0);
        list.add(fragment1);
    ...
    protected int provideContentViewId() {
        return R.layout.activity_taskahonest;
    }
