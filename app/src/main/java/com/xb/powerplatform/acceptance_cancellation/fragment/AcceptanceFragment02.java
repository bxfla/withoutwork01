...
import com.xb.powerplatform.acceptance_cancellation.adapter.AcceptanceAdapter02;
...
public class AcceptanceFragment02 extends Fragment {
    @Bind(R.id.recycleView)
    RecyclerView recycleView;
    AcceptanceAdapter02 adapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new AcceptanceAdapter02(getActivity(), list);
