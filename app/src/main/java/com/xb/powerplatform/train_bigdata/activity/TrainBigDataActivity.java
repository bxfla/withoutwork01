package com.xb.powerplatform.train_bigdata.activity;
...
import com.xb.powerplatform.train_bigdata.fragment.TrainBigDataFragment01;
import com.xb.powerplatform.train_bigdata.fragment.TrainBigDataFragment02;
 ...
 * 培训大数据
 */
public class TrainBigDataActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainbigdata);
        ButterKnife.bind(this);
        fragment0 = new TrainBigDataFragment01();
        fragment1 = new TrainBigDataFragment02();
        list.add(fragment0);
        list.add(fragment1);
    ...
    protected int provideContentViewId() {
        return R.layout.activity_trainbigdata;
    }
    //头部
    @Override
